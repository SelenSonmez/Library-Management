        ...
        <div class="login-page">
            <div class="form">
                <form action="/user/insert" method="post">
                    @csrf
                    <h2 style="text-align: center">Enter Credentials</h2>
                    ...
                    <input type="number" name="mobile" id="mobile" required placeholder="Contact No"><br>
                    <input style="background-color:#c5a3fd" type="submit" name="register"value="Register">
                </form>
            </div>
        </div>
    </div>
